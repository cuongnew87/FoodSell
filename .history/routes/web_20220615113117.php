...
Route::get('/forget-password', 'PageController@getEmail');

Route::post('/forget-password', 'PageController@postEmail');

Route::get('/reset-password/{token}', 'PageController@getPassword');

Route::post('/reset-password', 'PageController@updatePassword');

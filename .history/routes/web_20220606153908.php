...
Route::group(['prefix'=>'admin', 'middleware' => ['isAdmin']],function(){
    ...
    Route::group(['prefix'=>'User'],function(){
        ...
        Route::get('them', 'AdminController@getThemUser');
        Route::post('them','AdminController@postThemUser');

        Route::get('sua/{id}', 'AdminController@getSuaUser');
        Route::post('sua/{id}', 'AdminController@postSuaUser');


        Route::get('xoa/{id}', 'AdminController@getXoaUser');
    });

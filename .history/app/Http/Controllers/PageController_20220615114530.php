...
class PageController extends Controller
{
    ...
    public function postEmail(Request $request)
    {
        ...
        echo 'We have e-mailed your password reset link!';
        return view('page.DangNhapDangky')->with('message', 'We have e-emailed your password reset link!');;
    }

    public function getPassword($token) { 

        return view('page.ResetPassword', ['token' => $token]);
     }
     ...
     if(!$updatePassword)
       ...
       return redirect('/dang-nhap-dang-ki')->with('message', 'Your password has been changed!');

    ...
    public function postThanhToan(Request $request)
    {
        ...
        if($request->method_payment == "Thanh Toán Tiền Mặt"){
            ...
            $paypalConfig = [
                ...
                'return_url' => 'http://localhost:8087/FoodSell/public/thanh-toan/public/thanh-toan?paypal=success',
                'cancel_url' => 'http://localhost:8087/FoodSell/public/thanh-toan/public/thanh-toan?paypal=failed',
                'notify_url' => 'http://localhost:8087/FoodSell/public/thanh-toan/public/thanh-toan?paypal=notify',
            ];   

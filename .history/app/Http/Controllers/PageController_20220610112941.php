    ...
    public function postThanhToan(Request $request)
    {
        if($request->method_payment != "Paypal"){
            ...
            $paypalConfig = [
                ...
                'return_url' => env('VARIABLE_NAME') . 'http://localhost:8087/paypal-example/payment-successful.html?id=12345',
                'cancel_url' => 'http://localhost:8087/paypal-example/payment-cancelled.html',
                'notify_url' => 'http://localhost:8087/paypal-example/payments.php'
            ];            
        }
    }

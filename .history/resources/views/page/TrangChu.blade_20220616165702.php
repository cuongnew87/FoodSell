            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-6" id="product-<?php echo $index; ?>" value="<?php if($product->promotion_price != 0 && $product->unit_price > $product->promotion_price) echo $product->promotion_price; else echo $product->unit_price; ?>">
                            <?php $index++; ?>
...
function setBubble(range, bubble) {
  ...
  const min = range.min ? range.min : document.getElementById('pull-min').value;
  const max = range.max ? range.max : document.getElementById('pull-max').value;

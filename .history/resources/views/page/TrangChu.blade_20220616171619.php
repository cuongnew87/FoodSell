                                ...
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            @if($product->promotion_price != 0 && $product->unit_price > $product->promotion_price)
                                                ...
                                                <input type="hidden" id="price-<?php echo $index; ?>" value="<?php echo $product->promotion_price; ?>"/>
                                            @else
                                                <h2>{{number_format($product->unit_price)}}.đ</h2>
                                                <input type="hidden" id="price-<?php echo $index; ?>" value="<?php echo $product->unit_price; ?>"/>
                                            @endif
                                            <p>{{$product->name}}</p>
                                            @if($product->status == 0)

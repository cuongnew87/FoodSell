            ...
            <div class="col-sm-8">
                <div class="contact-form">
                    ...
                    <form  action="thanh-toan" id="main-contact-form" class="contact-form row" name="contact-form" method="post">
                        ...
                        <div class="form-group col-md-12">
                            <input type="hidden" id="method_payment" name="method_payment" value="Thanh Toán Tiền Mặt" checked="checked">
                        </div>
                        <div class="form-group col-md-12">
  ...
  paypal.Button.render({
    ...
    onAuthorize: function(data, actions) {
      return actions.payment.execute().then(function() {
        ...
        // save db
        document.getElementById("method_payment").value = 'Paypal';
        document.forms["main-contact-form"].submit();
      });
    }
  }, '#paypal-button');

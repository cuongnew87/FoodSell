                    ...
                    <div class="features_items">
                        ...
                        <div class="row">
                            ...
                            @foreach ($product as $product)
                                <div class="col-sm-4 col-6" style="max-height:422.84px id="product-<?php echo $index; ?>">
                                        ...
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                @if ($product->promotion_price != 0 && $product->unit_price > $product->promotion_price)
                                                    ...
                                                    <input type="hidden" id="price-<?php echo $index; ?>"
                                                        value="<?php echo $product->promotion_price; ?>" />
                                                @else
                                                ...
                                                <p>{{ $product->name }}</p>
                                                @if ($product->status == 0)
                                                    <a href="chi-tiet-sp/{{ $product->id }}"
                                                        class="btn btn-default add-to-cart"><i
                                                            class="fa fa-shopping-cart"></i>Hết hàng</a>
                                                @elseif($product->status == 1)
                                                    <a href="chi-tiet-sp/{{ $product->id }}"
                                                        class="btn btn-default add-to-cart"><i
                                                            class="fa fa-shopping-cart"></i>Còn hàng</a>
                                                @endif
                                            </div>
                                            <div class="product-overlay">
                                                <div class="overlay-content">
                                                    ...
                                                    <p>{{ $product->name }}</p>
                                                    <a href="chi-tiet-sp/{{ $product->id }}"
                                                        class="btn btn-default add-to-cart" style="cursor:pointer;"><i
                                                            class="fa fa-shopping-cart"></i>Đặt Món</a>
                                                </div>
                                            </div>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            @endif
                                            <p>{{ $new->name }}</p>
                                            <a href="chi-tiet-sp/{{ $new->id }}"
                                                class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Đặt
                                                Món</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                    ...
                                    @foreach ($productRemain as $productRemain)
                                        <div class="col-sm-4">
                                            <div class="product-image-wrapper">
                                                <div class="single-products">
                                                    <div class="productinfo text-center">
                                                        <img src="source/image/product/{{ $productRemain->image }}"
                                                            alt="" width="100%" />
                                                    ...
                                                    <div class="product-overlay">
                                                        <div class="overlay-content">
                                                            @if ($productRemain->promotion_price != 0 && $productRemain->unit_price > $productRemain->promotion_price)
                                                                <h2>{{ number_format($productRemain->promotion_price) }}.đ
                                                                </h2>
                                                                <p><del>{{ number_format($productRemain->unit_price) }}.đ</del>
                                                                </p>
                                                            @else
                                                                <h2>{{ number_format($productRemain->unit_price) }}.đ</h2>
                                                            @endif
                                                            <p>{{ $productRemain->name }}</p>
                                                            <a href="chi-tiet-sp/{{ $productRemain->id }}"
                                                                class="btn btn-default add-to-cart"><i
                                                                    class="fa fa-shopping-cart"></i>Đặt Món</a>
                                                        </div>
                                                    </div>
                                                    @if ($productRemain->promotion_price != 0)
                                                        <img src="source/images/home/sale.png" class="new"
                                                            alt="" />
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    @foreach ($productRemain1 as $productRemain1)
                                        <div class="col-sm-4">
                                            <div class="product-image-wrapper">
                                                <div class="single-products">
                                                    <div class="productinfo text-center">
                                                        <img src="source/image/product/{{ $productRemain1->image }}"
                                                            alt="" width="100%" />
                                                        @if ($productRemain1->promotion_price != 0 && $productRemain1->unit_price > $productRemain1->promotion_price)
                                                            <h2>{{ number_format($productRemain1->promotion_price) }}.đ
                                                            </h2>
                                                        @else
                                                    ...
                                                    <div class="product-overlay">
                                                        <div class="overlay-content">
                                                            @if ($productRemain1->promotion_price != 0 && $productRemain1->unit_price > $productRemain1->promotion_price)
                                                                ...
                                                                <p><del>{{ number_format($productRemain1->unit_price) }}.đ</del>
                                                                </p>
                                                            @else
                                                                <h2>{{ number_format($productRemain1->unit_price) }}.đ</h2>
                                                            @endif
                                                            <p>{{ $productRemain1->name }}</p>
                                                            <a href="chi-tiet-sp/{{ $productRemain1->id }}"
                                                                class="btn btn-default add-to-cart"><i
                                                                    class="fa fa-shopping-cart"></i>Đặt Món</a>
                                                        </div>
                                                    </div>

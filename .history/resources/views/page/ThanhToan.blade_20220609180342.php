            ...
            <div class="col-sm-8">
                <div class="contact-form">
                    ...
                    <form  action="thanh-toan" id="main-contact-form" class="contact-form row" name="contact-form" method="post">
                        ...
                        <div class="form-group col-md-12">
                                <input type="checkbox" name="method_payment" value="Thanh Toán Tiền Mặt">
                                <label for="">Thanh Toán Tiền Mặt</label>
                                <br>
                                <input type="checkbox" name="method_payment"  value="Paypal">
                        ...
                        <div class="form-group col-md-12">
                            <img type="image" name="submit" border="0" src="https://www.paypalobjects.com/en_US/i/btn/btn_buynow_LG.gif">
                        </div>
                    </form>
                </div>
            </div>

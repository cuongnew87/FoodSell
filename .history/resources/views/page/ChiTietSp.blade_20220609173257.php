                ...
                <div class="category-tab shop-details-tab"><!--category-tab-->
                    ...
                    <div class="tab-pane fade active in" id="reviews" >
                        <div class="col-sm-12">
                            ...
                            <ul>
                                <li><a href="#" style="pointer-events: none; cursor: default;"><img width="50" style="border-radius: 50%; margin-right:10px" src="source/image/user/{{$review->customer_image}}" /></i>{{ $review->customer_name }}</a></li>
                                <li><a href="#" style="pointer-events: none; cursor: default;"><i class="fa fa-clock-o"></i>{{ $review->created_at->format('h:i A') }}</a></li>
                                <li><a href="#" style="pointer-events: none; cursor: default;"><i class="fa fa-calendar-o"></i>{{ $review->created_at->format('Y-m-d') }}</a></li>
                            </ul>
                            <p>{{ $review->review }}</p>
                            @endforeach
                            <h3 style="text-transform: uppercase;"><b>Gửi Đánh Giá Của Bạn</b></h3>

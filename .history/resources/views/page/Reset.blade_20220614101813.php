        ...
        <section>
            <div class="container">
                <div style="display:flex; justify-content:center; margin-top:15px">
                    <section class="form" style="display:flex; justify-content:center;"><!--form-->
                        {{-- <div class="col-sm-4 col-sm-offset-1"> --}}
                            <div class="login-form">
                                ...
                                <form action="reset" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-default" style="text-align:center; display: inline-block">Gửi link xác nhận</button>
                                </form>
                            </div>
                        {{-- </div> --}}
                    </section><!--/form-->

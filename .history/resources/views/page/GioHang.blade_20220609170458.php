                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="cart_price">
                                ...
                                <span id="promotion_price{{$buy->id}}">{{$buy->promotion_price}}.đ</span>
                                @else
                                <span id="unit_price{{$buy->id}}">{{$buy->unit_price}}.đ</span>
                                @endif
                            </td>
                            <td>
                                @if($buy->status == 0)
                            ...
                            <td class="cart_quantity">
                                <div class="cart_quantity_button">
                                    ...
                                    <input class="cart_quantity_input" type="number" id ="{{$buy->id}}" onchange="changeQuantity({{$buy->id}})" name="soluong[]" value="{{$buy->soluong}}" size="2" min="0">

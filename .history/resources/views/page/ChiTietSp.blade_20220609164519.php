                    ...
                    <div class="col-sm-6">
                        <div class="layout">
                            <div class="product-information"><!--/product-information-->
                                ...
                                @else
                                <h2 style="color: #0e0d0d;font-size:30px">{{number_format($product_detail->unit_price)}}.đ</h2>
                                @endif
                                @if($product_detail->status == 0)
                                    <h2 style="color: #FE980F;font-size:30px">Còn hàng</h2>
                                @elseif($product_detail->status == 1)
                                    <h2 style="color: #FE980F;font-size:30px">Hết hàng</h2>
                                @endif
                                <hr>
                                <span>
                        ...
                        <div class="tab-pane fade active in" id="reviews" >
                            <div class="col-sm-12">
                                ...
                                <form action="review/{{$product_detail->id}}" method="POST" >
                                    <input type="hidden" name="_token" value="{{csrf_token('')}}">
                                    <span>
                                        <input type="text"  name = "name1"placeholder="Tên Khách Hàng"/>
                                        <input type="text"  name = "phone1" placeholder="Số Điện Thoại"/>
                                    </span>
                                    <textarea name="review1" placeholder="Nhập Đánh Giá" ></textarea>

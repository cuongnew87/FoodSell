            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    ...
                    <div>
                        ...
                        <div class="col-sm-4 p-1" style="display:flex">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <p>{{$product->name}}</p>
                                            @if()
                                            <a href="chi-tiet-sp/{{$product->id}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>{{$product->status}}</a>
                                        </div>

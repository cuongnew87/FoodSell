            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX" align="center">
                        ...
                        <th>{{$product->new}}</th>
                        <td ><i class="fa fa-pencil fa-fw"></i> <a href="admin/Product/sua/{{$product->id}}">Sửa</a></td>
                        <td ><i class="fa fa-trash-o fa-fw"></i><a href="admin/Product/xoa/{{$product->id}}">Xoá</a></td>
                    </tr>
                    <?php $index++; ?>
                    @endforeach
                </tbody>

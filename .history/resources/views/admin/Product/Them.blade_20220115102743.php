        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="admin/Product/them" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Giá Gốc</label>
                        <input class="form-control"  type = "text" name="unit_price" placeholder="Nhập Giá Gốc" />
                    </div>
                    <div class="form-group">
                        <label>Giá Khuyến Mãi</label>
                        <input class="form-control" type = "text" name="promotion_price" placeholder="Nhập Giá Khuyến Mãi" />
                    </div>
                    <div class="form-group">

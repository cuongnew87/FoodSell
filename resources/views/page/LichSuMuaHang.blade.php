                                        ...
                                        <div class="content-user">
                                            <div class="container">
                                                ...
                                                <table class="table-cart" cellspacing="0">
                                                    ...
                                                    <tr class="cart_item">
                                                        <td>
                                                            <img class="pull-left" src="source/image/product/{{$product->image}}" alt="" width="80px" height="80px">
                                                        </td>
                                                        <td class = "table-title1" >
                                                            <p class="font-large fix1">{{$product->name}}</p>
                                                        </td>
                                                        <td class="table-title">
                                                            <span>{{$product->soluong}}</span>
                                                        </td>
                                                        <td class="table-title">
                                                            <span>{{number_format($product->total)}}.đ</span>
                                                        </td>
                                                        <td class="table-title">
                                                            <span>{{$product->created_at}}</span>
                                                        </td>
                                                        <td class="cart_delete table-title">
                                                            <a class="cart_quantity_delete" href="xoa-lich-su-mua-hang/{{$product->id}}"><i class="fa fa-times"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                    @endif
